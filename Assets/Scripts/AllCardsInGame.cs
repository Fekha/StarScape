...
namespace Assets.Scripts
{
    internal class AllCardsInGame : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            allCards.Add(new FakeCard(1, 2, 1, 2, 6, 3, "Station", "On Attack: Gain 1 Attack", "Shepherd"));
            ...
            allCards.Add(new FakeCard(4, 3, 1, 4, 4, 0, "First", "None", "Carnation"));
            allCards.Add(new FakeCard(5, 2, 1, 6, 4, 3, "Station", "On Attack: Heals self 1 damage", "Crucialis"));
            ...
            allCards.Add(new FakeCard(8, 1, 2, 15, 6, 7, "First in Right Column", "Twice as likely to Misfire", "Tycho"));
            allCards.Add(new FakeCard(9, 2, 2, 4, 4, 1, "Skip", "On Arrival: Draw a card", "Mangler"));
            ...
            allCards.Add(new FakeCard(19, 2, 5, 19, 19, 0, "First", "None", "Prospect"));
            allCards.Add(new FakeCard(20, 3, 5, 40, 10, 4, "Consecutive", "On Attack: Deals 4 damage to itself", "Redeemer"));
        }
